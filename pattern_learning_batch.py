...
with tf.Session() as sess:
    ...
    for i in range( train_steps ):
        ...
        loss_no_cout.append(loss_before)
...
plt.savefig("/home/zhengmiao/cifar10/output_image/pattern_learning/all.png")

plt.figure()
plt.plot(list_count_no_cont,loss_no_cout)
plt.savefig("/home/zhengmiao/cifar10/output_image/pattern_learning/no_cont.png")
